...
- If the user intends to commit an archived task,
  follow [COMMIT-TASK.md](./references/actions/COMMIT-TASK.md) action.
...
- If the user intends to merge or rebase a branch and resolve conflicts,
  follow [MERGE-REBASE.md](./references/actions/MERGE-REBASE.md) action.
